...
import {
  ...
  ArrowsCounterClockwiseIcon, ArrowRightIcon, WavesIcon, ArrowLeftIcon,
...
export default function LearnDex() {
        ...
        <main className="flex-1 min-w-0 space-y-20">
          ...
          <div className="border-t border-slate-200 pt-12 pb-8 text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              ...
              <Link
                to="/learn/lending"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-emerald-200 text-emerald-700 text-sm font-medium hover:bg-emerald-50 transition-colors"
              >
                Prossima sezione: Prestiti & Collaterale <ArrowRightIcon size={14} weight="bold" />
              </Link>
            </div>
          </div>
        </main>
